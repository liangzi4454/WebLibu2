              								...
              								<table width="99%" height="419"  border="0" cellpadding="0" cellspacing="0" class="border0d">
                								<tr>
                  									<td height="455" align="center" valign="top" background="<%=basePath%>/images/2_11.jpg" bgcolor="#FFFFFF" style="background-repeat:repeat-x; ">
                  										 <s:form namespace="/childartic" action="childartic_update" method="post" enctype="multipart/form-data">
															 ...
															 <tr>
															 	<td>所属类别</td>
															 	<td colspan="4"><s:select name="firstChildinfoArticle.childinfoType.id" list="typeList" listKey="id" listValue="name" headerKey="" id="shengui" headerValue="---请选择---"/></td>
															 	<input type="hidden" name="firstChildinfoArticle.childinfoImage" value="${firstChildinfoArticle.childinfoImage }"/>
															 	<input type="hidden" name="firstChildinfoArticle.id" value="${firstChildinfoArticle.id}"/>
															 </tr>
															 <tr>
															 	<td>摘要</td>
															  ...
															  <tr>
															 	<td>内容</td>
															 	<td colspan="4"><FCK:editor instanceName="firstChildinfoArticle.childinfoContent" value="${firstChildinfoArticle.childinfoContent}" height="300" width="100%" /></td>
															 </tr>
															  <tr>
