              								...
              								<table width="99%" height="419"  border="0" cellpadding="0" cellspacing="0" class="border0d">
                								<tr>
                  									<td height="455" align="center" valign="top" background="<%=basePath%>/images/2_11.jpg" bgcolor="#FFFFFF" style="background-repeat:repeat-x; ">
                  										 <s:form namespace="/pregnantart" action="pregnantart_save" method="post" enctype="multipart/form-data">
															 <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="chart_list" >
															 <tr align="center" height="32" >
															 	<th colspan="4" style="background-color:#fff0f9;">添加孕妇文章</th>
															 </tr>
															 <tr>
															 ...
															 <tr>
															 	<td>所属类别</td>
															 	<td><s:select name="firstPregnantArticle.firstPregnantType.id" list="typeList" listKey="id" listValue="name" headerKey="" id="shengui" headerValue="---请选择---"/></td>
															 	<td>上传图片</td>
															 ...
															 <tr>
															  ...
															  <tr>
															 	<td>内容</td>
															 	<td colspan="4"><FCK:editor instanceName="firstPregnantArticle.pregnantContent" height="300" width="100%" /></td>
															 </tr>
															  <tr>
