				...
				if(choose == true) {
					$.ajax({
					   ...
					   success: function(msg){	
					   		...
					   		if(msg.msgname == "sccg") 
					   		{
					   			window.location = "${pageContext.request.contextPath}/ftype/ftype_list.action?page=${page}";
					   		}			   		
					 }});
				}
		}); /*****结束****/
													                      		...
													                      		<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="chart_list">
													                          		<tr align="right" background="images/001_57.jpg">
													                            		<td height="27" colspan="10" style="background-repeat:repeat-x;">
													                            			<a href="<%=basePath%>/ftype/ftype_create.action" target="main" class="text4">增加</a>
													                            		</td>
													                          		</tr>
													                          		<tr align="center" valign="middle">
															                            <td width="8%" height="27"  style="background-color:#fff0f9 "><strong> 序 号 </strong></td>
															                            <td width="13%" height="27"  style="background-color:#fff0f9 "><strong> 大类名称 </strong></td>
													                          		...
													                          		<s:iterator id="firsttype" value="pagination.list" status="userList">
													                          			<tr align="center" valign="middle">
																                            ...
																                            <td height="27">
																	                           	 <a href="<%=basePath%>/ftype/ftype_edit.action?id=${firsttype.id}" style="cursor:pointer" class="text4">修改</a>&nbsp;&nbsp;  
