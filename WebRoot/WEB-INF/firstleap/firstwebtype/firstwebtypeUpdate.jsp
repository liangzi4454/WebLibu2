              								...
              								<table width="99%" height="419"  border="0" cellpadding="0" cellspacing="0" class="border0d">
                								<tr>
                  									<td height="455" align="center" valign="top" background="<%=basePath%>/images/2_11.jpg" bgcolor="#FFFFFF" style="background-repeat:repeat-x; ">
                  										 <s:form namespace="/webtype" action="webtype_update" method="post" >
															 ...
															 <input type="hidden"  name="firstWebType.id" value="${firstWebType.id}"/>
															 <tr>
															 	<td>类型名称</td>
															  ...
															  <tr>
															 	<td>上级分类</td>
															 	<td><s:select name="firstWebType.firstType.id" list="tyList" listKey="id" listValue="name" headerKey="" id="shengui" headerValue="---请选择---"/></td>
															 </tr>
															  <tr>
															 	<td>排序</td>
