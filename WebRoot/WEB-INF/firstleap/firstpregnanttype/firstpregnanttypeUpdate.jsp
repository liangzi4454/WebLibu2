              								...
              								<table width="99%" height="419"  border="0" cellpadding="0" cellspacing="0" class="border0d">
                								<tr>
                  									<td height="455" align="center" valign="top" background="<%=basePath%>/images/2_11.jpg" bgcolor="#FFFFFF" style="background-repeat:repeat-x; ">
                  										 <s:form namespace="/pregnanttype" action="pregnanttype_update" method="post" >
															 <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="chart_list" >
															 <tr align="center" height="32" >
															 	<th colspan="4" style="background-color:#fff0f9;">孕妇类修改</th>
															 </tr>
															 <tr>
															 ...
															 <input type="hidden"  name="firstPregnantType.id" value="${firstPregnantType.id}"/>
															 <tr>
															 	<td>类型名称</td>
															 	<td><s:textfield name="firstPregnantType.name"></s:textfield></td>
															 </tr>
															  <tr>
															 	<td>上级分类</td>
															 	<td><s:select name="firstPregnantType.firstType.id" list="tyList" listKey="id" listValue="name" headerKey="" id="shengui" headerValue="---请选择---"/></td>
															 </tr>
															  <tr>
															 	<td>排序</td>
															 	<td><s:textfield name="firstPregnantType.paixu"></s:textfield></td>
															 </tr>
															  <tr>
