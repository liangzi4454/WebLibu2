				...
				if(choose == true) {
					$.ajax({
					   ...
					   success: function(msg){	
					   		...
					   		if(msg.msgname == "sccg") 
					   		{
					   			window.location = "${pageContext.request.contextPath}/pregnanttype/pregnanttype_list.action?page=${page}";
					   		}			   		
					 }});
				}
		}); /*****结束****/
													                      		...
													                      		<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="chart_list">
													                          		<tr align="right" background="images/001_57.jpg">
													                            		<td height="27" colspan="10" style="background-repeat:repeat-x;">
													                            			<a href="<%=basePath%>/pregnanttype/pregnanttype_create.action" target="main" class="text4">增加</a>
													                            		</td>
													                          		</tr>
