              								...
              								<table width="99%" height="419"  border="0" cellpadding="0" cellspacing="0" class="border0d">
                								<tr>
                  									<td height="455" align="center" valign="top" background="<%=basePath%>/images/2_11.jpg" bgcolor="#FFFFFF" style="background-repeat:repeat-x; ">
                  										 <s:form namespace="/webart" action="webart_save" method="post" enctype="multipart/form-data">
															 ...
															 <tr>
															 	<td>所属类别</td>
															 	<td><s:select name="firstWebArticle.firstWebType.id" list="typeList" listKey="id" listValue="name" headerKey="" id="shengui" headerValue="---请选择---"/></td>
															 	<td>上传图片</td>
															 ...
															 <tr>
															  ...
															  <tr>
															 	<td>内容</td>
															 	<td colspan="4"><FCK:editor instanceName="firstWebArticle.webContent" height="300" width="100%" /></td>
															 </tr>
															  <tr>
