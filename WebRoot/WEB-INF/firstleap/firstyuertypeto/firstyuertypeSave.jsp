              								...
              								<table width="99%" height="419"  border="0" cellpadding="0" cellspacing="0" class="border0d">
                								<tr>
                  									<td height="455" align="center" valign="top" background="<%=basePath%>/images/2_11.jpg" bgcolor="#FFFFFF" style="background-repeat:repeat-x; ">
                  										 <s:form namespace="/yuertype" action="yuertype_savei" method="post" >
															 ...
															 <tr>
															 	<td>类型名称</td>
															 	<td><s:textfield name="firstYuerType.name"></s:textfield></td>
															 </tr>
															<tr>
															 	<td>所属类别</td>
															 	<td><s:select name="firstYuerType.parentId" list="firstYuerfoList" listKey="id" listValue="name" headerKey="" id="shengui" headerValue="---请选择---"/></td>
															 </tr>
															  <tr>
															 	<td>排序</td>
															 	<td><s:textfield name="firstYuerType.paixu"></s:textfield></td>
															 </tr>
															  <tr>
