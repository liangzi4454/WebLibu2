...
<%@	taglib uri="/WEB-INF/conf/yuertype.tld"
	prefix="getyuername"%>
<%
				...
				if(choose == true) {
					$.ajax({
					   ...
					   success: function(msg){	
					   		...
					   		if(msg.msgname == "sccg") 
					   		{
					   			window.location = "${pageContext.request.contextPath}/yuertype/yuertype_listi.action?page=${page}";
					   		}			   		
					 }});
				}
		}); /*****结束****/
													                      		...
													                      		<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="chart_list">
													                          		<tr align="right" background="images/001_57.jpg">
													                            		<td height="27" colspan="10" style="background-repeat:repeat-x;">
													                            			<a href="<%=basePath%>/yuertype/yuertype_createi.action" target="main" class="text4">增加</a>
													                            		</td>
													                          		</tr>
													                          		<tr align="center" valign="middle">
															                            <td width="8%" height="27"  style="background-color:#fff0f9 "><strong> 序 号 </strong></td>
															                            <td width="13%" height="27"  style="background-color:#fff0f9 "><strong> 育儿二类 </strong></td>
													                          		...
													                          		<s:iterator id="firstyuertype" value="pagination.list" status="userList">
													                          			<tr align="center" valign="middle">
																                            ...
																                            <td height="27"><getyuername:getyuername areaId="${firstyuertype.parentId}" /></td>
																                            <td height="27">
