              								...
              								<table width="99%" height="419"  border="0" cellpadding="0" cellspacing="0" class="border0d">
                								<tr>
                  									<td height="455" align="center" valign="top" background="<%=basePath%>/images/2_11.jpg" bgcolor="#FFFFFF" style="background-repeat:repeat-x; ">
                  										 <s:form namespace="/ftype" action="ftype_savei" method="post" >
															 <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="chart_list" >
															 <tr align="center" height="32" >
															 	<th colspan="4" style="background-color:#fff0f9;">添加类别</th>
															 </tr>
															 <tr>
															 ...
															 <tr>
															 	<td>类别名称</td>
															 	<td><s:textfield name="firstType.name"></s:textfield></td>
															 </tr>
															 <tr>
															 	<td>上级分类</td>
															 	<td><s:select name="firstType.parentId" list="typeList" listKey="id" listValue="name" headerKey="" id="shengui" headerValue="---请选择---"/></td>
															 </tr>
															  <tr>
															 	<td>排序</td>
															 	<td><s:textfield name="firstType.paixu"></s:textfield></td>
															 </tr>
															  <tr>
