...
public class GetPatypeNameByIdTag extends TagSupport{
	...
	public int doEndTag() throws JspTagException{
		...
		IFirstPregnantTypeService areaservices = (IFirstPregnantTypeService)  AppModelFactory.getInstance("FirstPregnantTypeServiceImpl");
		FirstPregnantType area = areaservices.getByid(areaId);
		int sum = 0;
		if(null != area){
			try {
