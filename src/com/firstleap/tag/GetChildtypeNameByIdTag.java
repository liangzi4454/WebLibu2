...
public class GetChildtypeNameByIdTag extends TagSupport{
	...
	public int doEndTag() throws JspTagException{
		...
		IFirstChildinfoTypeService areaservices = (IFirstChildinfoTypeService)  AppModelFactory.getInstance("FirstChildinfoTypeServiceImpl");
		FirstChildinfoType area = areaservices.getByid(areaId);
		int sum = 0;
		if(null != area){
			try {
